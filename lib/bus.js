          ...
          if (promise && isPromise(promise)) {
            ...
            if (isValueNameYieldable) {
              ...
              return new Promise(function (resolve, reject) {
                ...
                var onFulfilledWithStateChange = (0, _helpers.decorate)(ctx.changeTaskState.bind(ctx, yieldableName, FULFILLED_STATE));
                var onRejectedWithStateChange = (0, _helpers.decorate)(ctx.changeTaskState.bind(ctx, yieldableName, REJECTED_STATE));
